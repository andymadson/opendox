    ...
    def create_config(self, project_name: str = "Documentation"):
        ...
        config = {
            ...
            'markdown_extensions': [
                ...
                'def_list',
                'pymdownx.tasklist',
                # pymdownx.emoji removed - causes Python 3.12 compatibility issues
                # Regular Unicode emoji work without this extension
                'toc'
            ],
...
-   **🔗 Source Code**
    ...
    [→ GitHub](https://github.com/andymadson/{project_lower})
